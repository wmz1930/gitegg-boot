...
CREATE TABLE `t_just_auth_social_user`  (
  ...
  `del_flag` tinyint(2) NOT NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '第三方用户关联关系' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `t_sys_sms_channel` VALUES (1, 0, 'aliyun', '阿里云短信', 'xxx', 'xxx', 'cn-hangzhou', 1, 10000000, '2122-12-31 23:59:59', '阿里云短信', '2021-01-26 15:19:11', 1, '2022-05-25 13:51:32', 1, 0);
...
-- ----------------------------
INSERT INTO `t_sys_sms_template` VALUES (1, 0, 1, 'sms_login_code', '登录验证码', 'SMS_152420163', 'xxx', 1, 1, 'SMS:CODE:LOGIN', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在登录，若非本人操作，请勿泄露。', '2022-05-25 13:39:21', 1, '2022-05-25 13:40:11', 1, 0);
INSERT INTO `t_sys_sms_template` VALUES (2, 0, 1, 'sms_register_code', '注册验证码', 'SMS_152420161', 'xxx', 1, 1, 'SMS:CODE:REGISTER', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在登录，若非本人操作，请勿泄露。', '2022-05-25 13:41:37', 1, '2022-05-25 13:41:46', 1, 0);
INSERT INTO `t_sys_sms_template` VALUES (3, 0, 1, 'sms_change_pwd_code', '修改密码验证码', 'SMS_152420160', 'xxx', 1, 1, 'SMS:CODE:CHANGE:PWD', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在尝试修改登录密码，请妥善保管账户信息。', '2022-05-25 13:43:35', 1, '2022-05-25 13:46:19', 1, 0);
INSERT INTO `t_sys_sms_template` VALUES (4, 0, 1, 'sms_change_info_code', '信息变更验证码', 'SMS_152420159', 'xxx', 1, 1, 'SMS:CODE:CHANGE:INFO', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在尝试变更重要信息，请妥善保管账户信息。', '2022-05-25 13:45:52', 1, '2022-05-25 14:44:47', 1, 0);
...
INSERT INTO `t_sys_user` VALUES (2, 0, 'test001', 'test001', 'test001', '0', 'test001@qq.com', '15853685632', '$2a$10$wm3EX5HnBslChBBYTgfP8e8B6jslFUreh/8bblJ1TRsSA2mOnDpoi', 1, NULL, NULL, '320000', '320300', '320303', '2342342343', '2342343', '2020-11-27 16:43:06', 1, '2021-12-22 17:06:16', 1, 0);
INSERT INTO `t_sys_user` VALUES (3, 0, 'test002', 'test002', 'test002', '1', 'test002@qq.com', '15851682557', '$2a$10$MBsO4f0tIMIIdjcLUSUNd.fu6yZakXRcK9Ck.XypALznIhMYpFUKG', 1, NULL, NULL, '320000', '320100', '320104', '234423423', '234234', '2020-11-27 02:55:30', 1, '2022-05-29 23:17:10', 17, 0);
