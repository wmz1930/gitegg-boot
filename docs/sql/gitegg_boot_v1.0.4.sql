/*
 ...
 Source Schema         : gitegg_boot

 Target Server Type    : MySQL
 Target Server Version : 50722
 File Encoding         : 65001

 Date: 27/07/2022 14:44:27
*/
...
-- ----------------------------
INSERT INTO `t_just_auth_config` VALUES (1, 0, 1, '111', 1, '2', '2', 3, 0, '333444', '2022-05-16 14:50:56', 1, '2022-05-18 11:30:09', 1, 0);
INSERT INTO `t_just_auth_config` VALUES (2, 0, 1, '', 3000, 'Redis', 'GITEGG:JUSTAUTH:', 60, 1, '', '2022-05-16 15:22:06', 1, '2022-05-16 15:39:13', 1, 0);
INSERT INTO `t_just_auth_config` VALUES (3, 0, 1, '322343241', 2221, 'REDIS1', 'ASDF:ASDF:ASDFAS1', 2001, 1, '3451', '2022-06-05 21:18:15', 1, '2022-06-05 21:20:47', 1, 0);
INSERT INTO `t_just_auth_config` VALUES (4, 0, 1, '34543', 333, 'reDIS', '2', 134, 1, '2343', '2022-06-05 21:19:33', 1, NULL, NULL, 0);
INSERT INTO `t_just_auth_config` VALUES (5, 0, 1, '234234', 234, '234', '234', 234, 1, '234', '2022-06-05 21:23:27', 1, NULL, NULL, 0);
INSERT INTO `t_just_auth_config` VALUES (6, 0, 1, '1', 1, '1', '1', 1, 1, '1', '2022-06-05 21:24:16', 1, NULL, NULL, 0);
INSERT INTO `t_just_auth_config` VALUES (7, 0, 1, '3', 3, '3', '3', 3, 1, '3', '2022-06-05 21:25:43', 1, NULL, NULL, 1);
INSERT INTO `t_just_auth_config` VALUES (8, 0, 1, '56', 56, '56', '56', 56, 0, '56', '2022-06-05 21:27:01', 1, '2022-06-05 21:27:40', 1, 0);
...
CREATE TABLE `t_just_auth_social`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '第三方用户信息表' ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
INSERT INTO `t_just_auth_social_user` VALUES (14, 0, 36, 14, '2022-06-05 20:23:36', NULL, NULL, NULL, 0);
INSERT INTO `t_just_auth_social_user` VALUES (15, 0, 36, 15, '2022-06-06 12:53:08', NULL, NULL, NULL, 0);
...
CREATE TABLE `t_just_auth_source`  (
  ...
  `del_flag` tinyint(2) NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 2 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '租户第三方登录信息配置表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_just_auth_source
-- ----------------------------
INSERT INTO `t_just_auth_source` VALUES (1, 0, 'DINGTALK', 'default', NULL, '11111111', '1111111111', 'http://192.168.0.2:8000/social/dingtalk/callback', NULL, 0, NULL, NULL, NULL, NULL, 1, '123,234,345', '', NULL, NULL, 1, NULL, 1, 'HTTP', '127.0.0.1', 8080, 1, '', '2022-05-19 16:00:36', 1, '2022-06-04 21:35:29', 1, 0);
...
-- ----------------------------
INSERT INTO `t_oauth_client_details` VALUES ('gitegg-admin', NULL, '{bcrypt}$2a$10$1Cc8Ji1PenKletLLR8paOur5KX1u5gStTeVKaLA2kFQzMjwLvsKTq', 'all', 'password,captcha,sms_captcha,social,refresh_token,authorization_code', NULL, 'admin', 3600, 7200, NULL, 'true', NULL, NULL, NULL, NULL, 0);
INSERT INTO `t_oauth_client_details` VALUES ('gitegg-weapp', NULL, '{bcrypt}$2a$10$3q73GZNZbZkKN5jnnj1wLuZ84N9RvQ19taTMzXcMxGzcmrBsFCJcO', 'all', 'password,captcha,sms_captcha,social,refresh_token,authorization_code', NULL, 'admin', 3600, 7200, NULL, 'true', NULL, NULL, NULL, NULL, 0);
...
-- ----------------------------
INSERT INTO `t_sys_code_generator_config` VALUES (1, 0, 75, '12', '12', '12', '12', '12', '12', '12', NULL, '12', '12', 0, '12', '12', '12', '12', '12', NULL, 1, 1, 1, 1, 'ALL', '2021-09-03 09:52:49', 1, '2021-09-03 09:53:10', 1, 1);
...
-- ----------------------------
INSERT INTO `t_sys_code_generator_datasource` VALUES (75, 0, '测试数据库001', 'jdbc:mysql://127.0.0.1/gitegg_cloud?zeroDateTimeBehavior=convertToNull&useUnicode=true&characterEncoding=utf8&all owMultiQueries=true&serverTimezone=Asia/Shanghai', 'root', 'root', '', 'mysql', '', '2021-11-11 19:06:11', 1, '2021-11-11 19:15:29', 1, 0);
...
CREATE TABLE `t_sys_data_permission_user`  (
  ...
  `del_flag` tinyint(2) NULL DEFAULT 0 COMMENT '1:删除 0:不删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 61 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '数据权限多部门' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_sys_dfs` VALUES (2, 0, 3, 'QINiuKODO', 'http://xxxxxxxx.com', 'http://upload.qiniup.com', 'gitegg', 'gitegg', 'zone0', 'xxxxxxxxxxxxx', 'xxxxxxxxxxxxxx', 0, 1, 0, '七牛云存储', '2021-05-06 14:09:50', 1, '2021-05-07 09:50:49', 1, 0);
...
CREATE TABLE `t_sys_mail_channel`  (
  ...
  `del_flag` tinyint(2) NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 9 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '邮件渠道' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_sys_mail_channel
-- ----------------------------
INSERT INTO `t_sys_mail_channel` VALUES (7, 0, 'aliyun_mail', '阿里云邮箱', 'smtp.mxhichina.com', 25, 'xxxxxxxxxx', 'xxxxxxxxxxx', 'smtp', NULL, NULL, 'mail.smtp.auth: true\nmail.smtp.ssl.enable: false', 1, 'xxxxxxxxxxxxxxxxx', NULL, '2022-06-24 16:22:49', 1, '2022-06-29 21:38:54', 1, 0);
INSERT INTO `t_sys_mail_channel` VALUES (8, 0, 'qq_mail', 'QQ邮箱', 'smtp.qq.com', 465, 'xxxxxxxxxxxxxx@qq.com', 'xxxxxxxxxxxxxxxxx', 'smtp', 'UTF-8', NULL, 'mail.smtp.auth: true\nmail.smtp.starttls.enable: true\nmail.smtp.starttls.required: true\nmail.smtp.ssl.enable: true', 0, 'xxxxxxxxxxxx', NULL, '2022-06-29 16:58:49', 1, '2022-06-29 17:24:57', 1, 0);
...
CREATE TABLE `t_sys_mail_log`  (
  ...
  `del_flag` tinyint(2) NOT NULL DEFAULT 0 COMMENT '是否删除 1:删除 0:不删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 57 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '邮件记录' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_sys_mail_log
-- ----------------------------
INSERT INTO `t_sys_mail_log` VALUES (2, 0, 234, 234234, '234', '23423423', '4234234', '2342', '3423', '4234324', '342', '2342', NULL, '1', '234', '2022-06-24 19:01:48', 1, NULL, NULL, 0);
...
CREATE TABLE `t_sys_mail_template`  (
  ...
  `del_flag` tinyint(2) NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 10 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '邮件模板' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_sys_mail_template` VALUES (9, 0, 'register_code', '注册验证码', '【GitEgg】', 1, 2, '您正在注册GitEgg，验证码为: {code}', 'gitegg:register:mail:code:', 600, 'min', 5, 5, 'min', '验证码邮件', '2022-06-28 18:18:43', 1, NULL, NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 304 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '权限表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_sys_resource` VALUES (2, 0, 1, '0,1', '系统管理', 'system:cfg', '2', 'xitongguanli', 'system/cfg', 'Layout', 999, 1, 1, NULL, 1, '配置管理', '2016-04-22 10:43:19', 1, '2022-07-15 17:58:22', 1, 0);
...
INSERT INTO `t_sys_resource` VALUES (10, 0, 297, '0,1,297', '定时任务', 'system:task', '2', 'timingtask', 'https://github.com/xuxueli/xxl-job', 'system/task', 3, 1, 1, 'XXLJob', 1, '', '2018-10-27 19:09:06', 1, '2021-09-30 16:36:50', 1, 0);
...
INSERT INTO `t_sys_resource` VALUES (125, 0, 1, '0,1', '代码生成', 'plugin:code', '2', 'xitongguanli', 'plugin/code/generator', 'nested', 998, 1, 1, NULL, 1, '代码生成', '2016-04-22 10:43:19', 1, '2022-07-15 17:58:14', 1, 0);
...
INSERT INTO `t_sys_resource` VALUES (207, 0, 2, '0,1,2', '第三方登录', 'social:login', '2', 'xitongrizhi', 'social', 'nested', 6, 1, 1, 'social', 1, '', '2022-05-16 14:12:52', 1, '2022-06-24 16:11:56', 1, 0);
...
INSERT INTO `t_sys_resource` VALUES (245, 0, 1, '0,1', '协同办公', 'plugin:workflow:oa', '2', 'xitongguanli', 'plugin/workflow/oa', 'nested', 2, 1, 1, NULL, 1, '协同办公', '2016-04-22 10:43:19', 1, '2022-06-16 18:00:17', 1, 0);
INSERT INTO `t_sys_resource` VALUES (246, 0, 1, '0,1', '流程管理', 'plugin:workflow:manager', '2', 'xitongguanli', 'plugin/workflow/manager', 'nested', 997, 1, 1, NULL, 1, '流程管理', '2016-04-22 10:43:19', 1, '2022-07-15 17:58:07', 1, 0);
INSERT INTO `t_sys_resource` VALUES (247, 0, 245, '0,1,245', '发起申请', 'plugin:workflow:oa:task:new:my', '2', 'quanxianguanli', 'plugin/workflow/oa/task/my/new', 'plugin/workflow/oa/task/my/new', 1, 1, 1, 'myTaskNew', 1, '发起新任务', '2016-04-22 10:43:19', 1, '2021-10-25 19:33:36', 1, 0);
INSERT INTO `t_sys_resource` VALUES (248, 0, 245, '0,1,245', '待处理的', 'plugin:workflow:oa:task:todo', '2', 'quanxianguanli', 'plugin/workflow/oa/task/todo', 'plugin/workflow/oa/task/todo', 2, 1, 1, 'todoTask', 1, '待处理的任务', '2016-04-22 10:43:19', 1, '2021-10-25 19:33:36', 1, 0);
INSERT INTO `t_sys_resource` VALUES (249, 0, 245, '0,1,245', '我发起的', 'plugin:workflow:oa:task:my', '2', 'quanxianguanli', 'plugin/workflow/oa/task/my', 'plugin/workflow/oa/task/my', 3, 1, 1, 'myTask', 1, '我发起的任务', '2016-04-22 10:43:19', 1, '2021-10-25 19:33:36', 1, 0);
INSERT INTO `t_sys_resource` VALUES (250, 0, 245, '0,1,245', '已处理的', 'plugin:workflow:oa:task:todo:my', '2', 'quanxianguanli', 'plugin/workflow/oa/task/todo/my', 'plugin/workflow/oa/task/todo/my', 4, 1, 1, 'myTodoTask', 1, '我收到的任务', '2016-04-22 10:43:19', 1, '2021-10-25 19:33:36', 1, 0);
INSERT INTO `t_sys_resource` VALUES (251, 0, 246, '0,1,246', '流程设计', 'plugin:workflow:manager:design', '2', 'quanxianguanli', 'plugin/workflow/manager/design/list', 'plugin/workflow/manager/designTable', 1, 1, 1, 'processDesign', 1, '流程设计', '2016-04-22 10:43:19', 1, '2022-06-16 18:24:38', 1, 0);
INSERT INTO `t_sys_resource` VALUES (252, 0, 246, '0,1,246', '流程模型', 'plugin:workflow:manager:bpmn', '2', 'quanxianguanli', 'plugin/workflow/manager/bpmn', 'plugin/workflow/manager/bpmnTable', 2, 1, 1, 'processDesign', 1, '流程模型转换', '2016-04-22 10:43:19', 1, '2021-10-25 19:33:36', 1, 0);
INSERT INTO `t_sys_resource` VALUES (253, 0, 247, '0,1,245,247', '我的申请列表', 'plugin:workflow:oa:task:new:my:list', '4', 'quanxianguanli', 'plugin/workflow/oa/task/my/new/list', '/gitegg-plugin-workflow/workflow/oa/task/my/new/list', 1, 1, 1, '', 1, '我的申请列表', '2016-04-22 10:43:19', 1, '2018-11-02 14:48:15', 1, 0);
INSERT INTO `t_sys_resource` VALUES (254, 0, 246, '0,1,246', '流程设计器', 'plugin:workflow:manager:design:modeler', '2', 'quanxianguanli', 'plugin/workflow/manager/design/modeler', 'plugin/workflow/manager/modeler/Index', 1, 0, 1, 'processDesignModeler', 1, '流程设计器', '2016-04-22 10:43:19', 1, '2022-06-17 15:03:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (255, 0, 251, '0,1,246,251', '基础配置', 'plugin:workflow:manager:design:modeler:base', '2', 'quanxianguanli', 'plugin/workflow/manager/design/modeler/base', 'plugin/workflow/manager/modeler/settings/baseSetting', 1, 0, 1, 'processDesignBase', 1, '基础配置', '2016-04-22 10:43:19', 1, '2022-06-17 14:55:51', 1, 0);
INSERT INTO `t_sys_resource` VALUES (256, 0, 251, '0,1,246,251', '表单设计', 'plugin:workflow:manager:design:modeler:form', '2', 'quanxianguanli', 'plugin/workflow/manager/design/modeler/form', 'plugin/workflow/manager/modeler/settings/formSetting', 1, 0, 1, 'processDesignForm', 1, '表单配置', '2016-04-22 10:43:19', 1, '2022-06-17 14:55:51', 1, 0);
INSERT INTO `t_sys_resource` VALUES (257, 0, 251, '0,1,246,251', '流程设计', 'plugin:workflow:manager:design:modeler:process', '2', 'quanxianguanli', 'plugin/workflow/manager/design/modeler/process', 'plugin/workflow/manager/modeler/settings/processSetting', 1, 0, 1, 'processDesignProcess', 1, '流程配置', '2016-04-22 10:43:19', 1, '2022-06-17 14:55:51', 1, 0);
INSERT INTO `t_sys_resource` VALUES (258, 0, 251, '0,1,246,251', '高级设计', 'plugin:workflow:manager:design:modeler:pro', '2', 'quanxianguanli', 'plugin/workflow/manager/design/modeler/pro', 'plugin/workflow/manager/modeler/settings/proSetting', 1, 0, 1, 'processDesignPro', 1, '高级配置', '2016-04-22 10:43:19', 1, '2022-06-17 14:55:51', 1, 0);
INSERT INTO `t_sys_resource` VALUES (259, 0, 270, '0,1,2,270', '邮件渠道', 'gitegg:service:extension:extension:mail:channel:table', '2', 'jiaoseguanli', 'gitegg/service/extension/extension/mail/channel/table', 'system/extension/mail/mailChannelTable.vue', 1, 1, 1, 'mailChannelTable', 1, '邮件渠道表', '2022-06-24 15:58:39', 1, '2022-07-05 23:37:19', 1, 0);
INSERT INTO `t_sys_resource` VALUES (260, 0, 259, '0,1,2,270,259', '获取邮件渠道表列表', 'gitegg:service:extension:extension:mail:channel:list', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/channel/list', '/gitegg-service-extension/extension/mail/channel/list', 2, 1, 1, NULL, 1, '获取邮件渠道表列表数据', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (261, 0, 259, '0,1,2,270,259', '添加邮件渠道表', 'gitegg:service:extension:extension:mail:channel:create', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/channel/create', '/gitegg-service-extension/extension/mail/channel/create', 2, 1, 1, NULL, 1, '添加邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (262, 0, 259, '0,1,2,270,259', '更新邮件渠道表', 'gitegg:service:extension:extension:mail:channel:update', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/channel/update', '/gitegg-service-extension/extension/mail/channel/update', 2, 1, 1, NULL, 1, '更新邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (263, 0, 259, '0,1,2,270,259', '删除邮件渠道表', 'gitegg:service:extension:extension:mail:channel:delete', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/channel/delete', '/gitegg-service-extension/extension/mail/channel/delete/{mailChannelId}', 2, 1, 1, NULL, 1, '删除邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (264, 0, 259, '0,1,2,270,259', '批量删除邮件渠道表', 'gitegg:service:extension:extension:mail:channel:batch:delete', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/channel/batch/delete', '/gitegg-service-extension/extension/mail/channel/batch/delete', 2, 1, 1, NULL, 1, '批量删除邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (265, 0, 259, '0,1,2,270,259', '邮件渠道表状态修改', 'gitegg:service:extension:extension:mail:channel:status', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/channel/status', '/gitegg-service-extension/extension/mail/channel/status/{mailChannelId}/{mailChannelStatus}', 2, 1, 1, NULL, 1, '批量删除邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (266, 0, 259, '0,1,2,270,259', '邮件渠道表字段校验是否存在', 'gitegg:service:extension:extension:mail:channel:check', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/channel/check', '/gitegg-service-extension/extension/mail/channel/check', 2, 1, 1, NULL, 1, '字段校验是否存在邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (267, 0, 259, '0,1,2,270,259', '邮件渠道表数据导出', 'gitegg:service:extension:extension:mail:channel:download', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/channel/download', '/gitegg-service-extension/extension/mail/channel/download', 2, 1, 1, NULL, 1, '数据导出邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (268, 0, 259, '0,1,2,270,259', '邮件渠道表数据导入模板下载', 'gitegg:service:extension:extension:mail:channel:download:template', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/channel/download/template', '/gitegg-service-extension/extension/mail/channel/download/template', 2, 1, 1, NULL, 1, '数据导入模板下载邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (269, 0, 259, '0,1,2,270,259', '邮件渠道表数据导入', 'gitegg:service:extension:extension:mail:channel:upload', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/channel/upload', '/gitegg-service-extension/extension/mail/channel/upload', 2, 1, 1, NULL, 1, '数据导入邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (270, 0, 2, '0,1,2', '邮件配置', 'extension:mail:table', '2', 'jiaoseguanli', 'extension/mail/table', 'nested', 5, 1, 1, 'mailTable', 1, '邮箱配置', '2016-04-22 10:43:19', 1, '2022-07-05 23:40:42', 1, 0);
INSERT INTO `t_sys_resource` VALUES (271, 0, 270, '0,1,2,270', '邮件模板', 'gitegg:service:extension:extension:mail:template:table', '2', 'jiaoseguanli', 'gitegg/service/extension/extension/mail/template/table', 'system/extension/mail/mailTemplateTable.vue', 2, 1, 1, 'mailTemplateTable', 1, '邮件模板', '2022-06-24 17:32:23', 1, '2022-07-05 23:37:30', 1, 0);
INSERT INTO `t_sys_resource` VALUES (272, 0, 271, '0,1,2,270,271', '获取邮件模板列表', 'gitegg:service:extension:extension:mail:template:list', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/template/list', '/gitegg-service-extension/extension/mail/template/list', 2, 1, 1, NULL, 1, '获取邮件模板列表数据', '2022-06-24 17:32:23', 1, '2022-06-24 17:32:23', 1, 0);
INSERT INTO `t_sys_resource` VALUES (273, 0, 271, '0,1,2,270,271', '添加邮件模板', 'gitegg:service:extension:extension:mail:template:create', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/template/create', '/gitegg-service-extension/extension/mail/template/create', 2, 1, 1, NULL, 1, '添加邮件模板', '2022-06-24 17:32:23', 1, '2022-06-24 17:32:23', 1, 0);
INSERT INTO `t_sys_resource` VALUES (274, 0, 271, '0,1,2,270,271', '更新邮件模板', 'gitegg:service:extension:extension:mail:template:update', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/template/update', '/gitegg-service-extension/extension/mail/template/update', 2, 1, 1, NULL, 1, '更新邮件模板', '2022-06-24 17:32:23', 1, '2022-06-24 17:32:23', 1, 0);
INSERT INTO `t_sys_resource` VALUES (275, 0, 271, '0,1,2,270,271', '删除邮件模板', 'gitegg:service:extension:extension:mail:template:delete', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/template/delete', '/gitegg-service-extension/extension/mail/template/delete/{mailTemplateId}', 2, 1, 1, NULL, 1, '删除邮件模板', '2022-06-24 17:32:23', 1, '2022-06-24 17:32:23', 1, 0);
INSERT INTO `t_sys_resource` VALUES (276, 0, 271, '0,1,2,270,271', '批量删除邮件模板', 'gitegg:service:extension:extension:mail:template:batch:delete', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/template/batch/delete', '/gitegg-service-extension/extension/mail/template/batch/delete', 2, 1, 1, NULL, 1, '批量删除邮件模板', '2022-06-24 17:32:23', 1, '2022-06-24 17:32:23', 1, 0);
INSERT INTO `t_sys_resource` VALUES (277, 0, 271, '0,1,2,270,271', '邮件模板状态修改', 'gitegg:service:extension:extension:mail:template:status', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/template/status', '/gitegg-service-extension/extension/mail/template/status/{mailTemplateId}/{mailTemplateStatus}', 2, 1, 1, NULL, 1, '批量删除邮件模板', '2022-06-24 17:32:23', 1, '2022-06-24 17:32:23', 1, 0);
INSERT INTO `t_sys_resource` VALUES (278, 0, 271, '0,1,2,270,271', '邮件模板字段校验是否存在', 'gitegg:service:extension:extension:mail:template:check', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/template/check', '/gitegg-service-extension/extension/mail/template/check', 2, 1, 1, NULL, 1, '字段校验是否存在邮件模板', '2022-06-24 17:32:23', 1, '2022-06-24 17:32:23', 1, 0);
INSERT INTO `t_sys_resource` VALUES (279, 0, 271, '0,1,2,270,271', '邮件模板数据导出', 'gitegg:service:extension:extension:mail:template:download', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/template/download', '/gitegg-service-extension/extension/mail/template/download', 2, 1, 1, NULL, 1, '数据导出邮件模板', '2022-06-24 17:32:23', 1, '2022-06-24 17:32:23', 1, 0);
INSERT INTO `t_sys_resource` VALUES (280, 0, 271, '0,1,2,270,271', '邮件模板数据导入模板下载', 'gitegg:service:extension:extension:mail:template:download:template', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/template/download/template', '/gitegg-service-extension/extension/mail/template/download/template', 2, 1, 1, NULL, 1, '数据导入模板下载邮件模板', '2022-06-24 17:32:23', 1, '2022-06-24 17:32:23', 1, 0);
INSERT INTO `t_sys_resource` VALUES (281, 0, 271, '0,1,2,270,271', '邮件模板数据导入', 'gitegg:service:extension:extension:mail:template:upload', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/template/upload', '/gitegg-service-extension/extension/mail/template/upload', 2, 1, 1, NULL, 1, '数据导入邮件模板', '2022-06-24 17:32:23', 1, '2022-06-24 17:32:23', 1, 0);
INSERT INTO `t_sys_resource` VALUES (282, 0, 270, '0,1,2,270', '邮件记录', 'gitegg:service:extension:extension:mail:log:table', '2', 'jiaoseguanli', 'gitegg/service/extension/extension/mail/log/table', 'system/extension/mail/mailLogTable.vue', 3, 1, 1, 'mailLogTable', 1, '邮件记录', '2022-06-24 18:31:40', 1, '2022-06-24 18:40:35', 1, 0);
INSERT INTO `t_sys_resource` VALUES (283, 0, 282, '0,1,2,270,282', '获取邮件记录列表', 'gitegg:service:extension:extension:mail:log:list', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/log/list', '/gitegg-service-extension/extension/mail/log/list', 2, 1, 1, NULL, 1, '获取邮件记录列表数据', '2022-06-24 18:31:40', 1, '2022-06-24 18:31:40', 1, 0);
INSERT INTO `t_sys_resource` VALUES (284, 0, 282, '0,1,2,270,282', '添加邮件记录', 'gitegg:service:extension:extension:mail:log:create', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/log/create', '/gitegg-service-extension/extension/mail/log/create', 2, 1, 1, NULL, 1, '添加邮件记录', '2022-06-24 18:31:40', 1, '2022-06-24 18:31:40', 1, 0);
INSERT INTO `t_sys_resource` VALUES (285, 0, 282, '0,1,2,270,282', '更新邮件记录', 'gitegg:service:extension:extension:mail:log:update', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/log/update', '/gitegg-service-extension/extension/mail/log/update', 2, 1, 1, NULL, 1, '更新邮件记录', '2022-06-24 18:31:40', 1, '2022-06-24 18:31:40', 1, 0);
INSERT INTO `t_sys_resource` VALUES (286, 0, 282, '0,1,2,270,282', '删除邮件记录', 'gitegg:service:extension:extension:mail:log:delete', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/log/delete', '/gitegg-service-extension/extension/mail/log/delete/{mailLogId}', 2, 1, 1, NULL, 1, '删除邮件记录', '2022-06-24 18:31:40', 1, '2022-06-24 18:31:40', 1, 0);
INSERT INTO `t_sys_resource` VALUES (287, 0, 282, '0,1,2,270,282', '批量删除邮件记录', 'gitegg:service:extension:extension:mail:log:batch:delete', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/log/batch/delete', '/gitegg-service-extension/extension/mail/log/batch/delete', 2, 1, 1, NULL, 1, '批量删除邮件记录', '2022-06-24 18:31:40', 1, '2022-06-24 18:31:40', 1, 0);
INSERT INTO `t_sys_resource` VALUES (288, 0, 282, '0,1,2,270,282', '邮件记录字段校验是否存在', 'gitegg:service:extension:extension:mail:log:check', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/log/check', '/gitegg-service-extension/extension/mail/log/check', 2, 1, 1, NULL, 1, '字段校验是否存在邮件记录', '2022-06-24 18:31:40', 1, '2022-06-24 18:31:40', 1, 0);
INSERT INTO `t_sys_resource` VALUES (289, 0, 282, '0,1,2,270,282', '邮件记录数据导出', 'gitegg:service:extension:extension:mail:log:download', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/log/download', '/gitegg-service-extension/extension/mail/log/download', 2, 1, 1, NULL, 1, '数据导出邮件记录', '2022-06-24 18:31:40', 1, '2022-06-24 18:31:40', 1, 0);
INSERT INTO `t_sys_resource` VALUES (290, 0, 282, '0,1,2,270,282', '邮件记录数据导入模板下载', 'gitegg:service:extension:extension:mail:log:download:template', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/log/download/template', '/gitegg-service-extension/extension/mail/log/download/template', 2, 1, 1, NULL, 1, '数据导入模板下载邮件记录', '2022-06-24 18:31:40', 1, '2022-06-24 18:31:40', 1, 0);
INSERT INTO `t_sys_resource` VALUES (291, 0, 282, '0,1,2,270,282', '邮件记录数据导入', 'gitegg:service:extension:extension:mail:log:upload', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/log/upload', '/gitegg-service-extension/extension/mail/log/upload', 2, 1, 1, NULL, 1, '数据导入邮件记录', '2022-06-24 18:31:40', 1, '2022-06-24 18:31:40', 1, 0);
INSERT INTO `t_sys_resource` VALUES (292, 0, 259, '0,1,2,270,259', '测试发送简单邮件', 'gitegg:service:extension:extension:mail:test:send:simple', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/test/send/simple', '/gitegg-service-extension/extension/mail/test/send/simple', 2, 1, 1, NULL, 1, '添加邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (293, 0, 259, '0,1,2,270,259', '测试发送Html邮件', 'gitegg:service:extension:extension:mail:test:send:html', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/test/send/html', '/gitegg-service-extension/extension/mail/test/send/html', 2, 1, 1, NULL, 1, '添加邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (294, 0, 259, '0,1,2,270,259', '测试发送模板邮件', 'gitegg:service:extension:extension:mail:test:send:template', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/test/send/template', '/gitegg-service-extension/extension/mail/test/send/template', 2, 1, 1, NULL, 1, '添加邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (295, 0, 259, '0,1,2,270,259', '测试发送发送带附件邮件', 'gitegg:service:extension:extension:mail:test:send:attachment', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/test/send/attachment', '/gitegg-service-extension/extension/mail/test/send/attachment', 2, 1, 1, NULL, 1, '添加邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (296, 0, 259, '0,1,2,270,259', '测试异步发送带附件邮件', 'gitegg:service:extension:extension:mail:test:send:async:attachment', '4', 'xitongrizhi', 'gitegg/service/extension/extension/mail/test/send/async/attachment', '/gitegg-service-extension/extension/mail/test/send/async/attachment', 2, 1, 1, NULL, 1, '添加邮件渠道表', '2022-06-24 15:58:39', 1, '2022-06-24 15:58:39', 1, 0);
INSERT INTO `t_sys_resource` VALUES (297, 0, 1, '0,1', '系统工具', 'system:tool', '2', 'xitongguanli', '/system/tool', 'nested', 996, 1, 1, 'nested', 1, '系统工具', '2022-07-15 17:57:32', 1, '2022-07-27 14:30:38', 1, 0);
INSERT INTO `t_sys_resource` VALUES (298, 0, 297, '0,1,297', '接口文档', 'system:tool:swagger', '2', 'quanxianguanli', 'http://127.0.0.1:8080/doc.html', 'system/too/swagger', 1, 1, 1, 'Swagger', 1, '接口文档', '2016-04-22 10:43:19', 1, '2021-10-25 19:33:36', 1, 0);
INSERT INTO `t_sys_resource` VALUES (299, 0, 302, '0,1,302', '微服务监控', 'system:tool:monitor:service', '2', 'quanxianguanli', 'http://192.168.226.1:8082/monitor', 'system/tool/monitor/service', 2, 1, 1, 'ServiceMonitor', 1, '微服务监控', '2016-04-22 10:43:19', 1, '2021-10-25 19:33:36', 1, 0);
INSERT INTO `t_sys_resource` VALUES (300, 0, 302, '0,1,302', '服务器监控', 'system:tool:monitor:server', '2', 'quanxianguanli', 'http://192.168.226.1:8082/monitor', 'system/tool/monitor/server', 3, 1, 1, 'ServerMonitor', 1, '服务器监控', '2016-04-22 10:43:19', 1, '2021-10-25 19:33:36', 1, 0);
INSERT INTO `t_sys_resource` VALUES (301, 0, 302, '0,1,302', '数据库监控', 'system:tool:monitor:db', '2', 'quanxianguanli', 'http://127.0.0.1:8080/druid/index.html', 'system/tool/monitor/db', 4, 1, 1, 'DBMonitor', 1, '数据库监控', '2016-04-22 10:43:19', 1, '2021-10-25 19:33:36', 1, 0);
INSERT INTO `t_sys_resource` VALUES (302, 0, 1, '0,1', '系统监控', 'system:monitor', '2', 'xitongguanli', 'system/monitor', 'nested', 1000, 1, 1, NULL, 1, '系统监控', '2016-04-22 10:43:19', 1, '2022-07-15 23:14:19', 1, 0);
INSERT INTO `t_sys_resource` VALUES (303, 0, 302, '0,1,302', 'Skywalking', 'system:tool:monitor:skywalking', '2', 'quanxianguanli', 'http://192.168.226.1:8082/monitor', 'system/tool/monitor/skywalking', 2, 1, 1, 'SkywalkingMonitor', 1, 'Skywalking链路追踪', '2016-04-22 10:43:19', 1, '2021-10-25 19:33:36', 1, 0);
...
CREATE TABLE `t_sys_role_resource`  (
  ...
  `del_flag` tinyint(2) NOT NULL DEFAULT 0 COMMENT '1:删除 0:不删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 356 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色和权限关联表' ROW_FORMAT = DYNAMIC;
...
INSERT INTO `t_sys_role_resource` VALUES (332, 0, 2, 245, '2022-06-16 17:54:49', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (333, 0, 2, 247, '2022-06-16 17:54:49', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (334, 0, 2, 248, '2022-06-16 17:54:49', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (335, 0, 2, 249, '2022-06-16 17:54:49', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (336, 0, 2, 250, '2022-06-16 17:54:49', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (337, 0, 2, 246, '2022-06-16 17:54:49', 1, NULL, NULL, 1);
...
INSERT INTO `t_sys_role_resource` VALUES (341, 0, 2, 252, '2022-06-16 18:25:29', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (342, 0, 2, 251, '2022-06-16 18:25:29', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (343, 0, 2, 253, '2022-06-16 18:25:29', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (344, 0, 2, 254, '2022-06-17 14:56:16', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (345, 0, 2, 248, '2022-07-27 14:28:23', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (346, 0, 2, 255, '2022-07-27 14:28:23', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (347, 0, 2, 258, '2022-07-27 14:28:23', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (348, 0, 2, 257, '2022-07-27 14:28:23', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (349, 0, 2, 256, '2022-07-27 14:28:23', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (350, 0, 2, 251, '2022-07-27 14:28:23', 1, NULL, NULL, 1);
INSERT INTO `t_sys_role_resource` VALUES (351, 0, 2, 297, '2022-07-27 14:28:23', 1, NULL, NULL, 0);
INSERT INTO `t_sys_role_resource` VALUES (352, 0, 2, 298, '2022-07-27 14:28:23', 1, NULL, NULL, 0);
INSERT INTO `t_sys_role_resource` VALUES (353, 0, 2, 302, '2022-07-27 14:28:23', 1, NULL, NULL, 0);
INSERT INTO `t_sys_role_resource` VALUES (354, 0, 2, 299, '2022-07-27 14:28:23', 1, NULL, NULL, 0);
INSERT INTO `t_sys_role_resource` VALUES (355, 0, 2, 301, '2022-07-27 14:28:23', 1, NULL, NULL, 0);
...
-- ----------------------------
INSERT INTO `t_sys_sms_channel` VALUES (1, 0, 'aliyun', '阿里云短信', 'xxxxxxxxxxxxxx', 'xxxxxxxxxxxx', 'cn-hangzhou', 1, 10000000, '2122-12-31 23:59:59', '阿里云短信', '2021-01-26 15:19:11', 1, '2022-05-25 13:51:32', 1, 0);
...
CREATE TABLE `t_sys_sms_template`  (
  ...
  `del_flag` tinyint(2) NULL DEFAULT 0 COMMENT '是否删除',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci COMMENT = '短信配置表' ROW_FORMAT = DYNAMIC;

-- ----------------------------
-- Records of t_sys_sms_template
-- ----------------------------
INSERT INTO `t_sys_sms_template` VALUES (1, 0, 1, 'sms_login_code', '登录验证码', 'SMS_152420163', 'xxxxxxxxxx', 1, 1, 'SMS:CODE:LOGIN', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在登录，若非本人操作，请勿泄露。', '2022-05-25 13:39:21', 1, '2022-05-25 13:40:11', 1, 0);
INSERT INTO `t_sys_sms_template` VALUES (2, 0, 1, 'sms_register_code', '注册验证码', 'SMS_152420161', 'xxxxxxxxx', 1, 1, 'SMS:CODE:REGISTER', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在登录，若非本人操作，请勿泄露。', '2022-05-25 13:41:37', 1, '2022-05-25 13:41:46', 1, 0);
INSERT INTO `t_sys_sms_template` VALUES (3, 0, 1, 'sms_change_pwd_code', '修改密码验证码', 'SMS_152420160', 'xxxxxxxxx', 1, 1, 'SMS:CODE:CHANGE:PWD', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在尝试修改登录密码，请妥善保管账户信息。', '2022-05-25 13:43:35', 1, '2022-05-25 13:46:19', 1, 0);
INSERT INTO `t_sys_sms_template` VALUES (4, 0, 1, 'sms_change_info_code', '信息变更验证码', 'SMS_152420159', 'xxxxxxxxxx', 1, 1, 'SMS:CODE:CHANGE:INFO', 5, 'MINUTES', 10, 24, 'HOURS', '验证码${code}，您正在尝试变更重要信息，请妥善保管账户信息。', '2022-05-25 13:45:52', 1, '2022-05-25 14:44:47', 1, 0);
...
INSERT INTO `t_sys_user` VALUES (3, 0, 'test002', 'test002', 'test002', '1', 'test002@qq.com', '15850682557', '$2a$10$MBsO4f0tIMIIdjcLUSUNd.fu6yZakXRcK9Ck.XypALznIhMYpFUKG', 1, NULL, NULL, '320000', '320100', '320104', '234423423', '234234', '2020-11-27 02:55:30', 1, '2022-05-29 23:17:10', 17, 0);
...
INSERT INTO `t_sys_user` VALUES (37, 0, '15570775688', '测试1', NULL, '2', NULL, '15570775688', '{bcrypt}$2a$10$Uk56Zac5kjowa048B0Y5KO.5OleDPGMNW9ap6IS3Ujx1FZCDJO0CS', 1, NULL, NULL, NULL, NULL, NULL, NULL, NULL, '2022-06-17 16:47:06', NULL, NULL, NULL, 0);
...
) ENGINE = InnoDB AUTO_INCREMENT = 45 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户和角色关联表' ROW_FORMAT = DYNAMIC;
