...
import com.gitegg.boot.generator.engine.GitEggDatabaseQuery;
import com.gitegg.boot.generator.engine.constant.CodeGeneratorConstant;
import com.gitegg.boot.generator.engine.dto.TableDTO;
import com.gitegg.boot.generator.engine.enums.CustomFileEnum;
...
import com.gitegg.boot.generator.field.util.FieldUtils;
import com.gitegg.boot.generator.join.entity.TableJoin;
import com.gitegg.boot.generator.join.service.ITableJoinService;
import com.gitegg.boot.system.service.IResourceService;
import com.gitegg.boot.generator.engine.enums.CustomFileJoinQueryEnum;
import com.gitegg.boot.generator.engine.enums.CustomFileMainSubEnum;
import com.gitegg.boot.generator.engine.enums.CustomFileMainSubExtendsEnum;
...
public class EngineServiceImpl implements IEngineService {
    ...
    private boolean processGenerateSingleCode(QueryConfigDTO queryConfigDTO, Config config){
        ...
        Long result = resourceService.queryResourceMaxId();
        if (null != result)
        {
            maxId = result + GitEggConstant.ONE_LONG;
        }
            ...
            FastAutoGenerator.create(datasource.getUrl(), datasource.getUsername(), datasource.getPassword())
                    ...
                    .injectionConfig(builder -> {
                        ...
                        else
                        {
                            if (extendsFlag)
                            {
                                customFileMap.put(dtoFile, com.gitegg.boot.generator.engine.enums.CustomFileMainSubEnum.DTO_FILE.path);
