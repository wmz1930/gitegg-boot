package com.gitegg.boot.extension.dfs.enums;
...
public enum DfsFactoryClassEnum {
     ...
     * MINIO MINIO
     */
    MINIO("MINIO", "com.gitegg.boot.extension.dfs.factory.DfsMinioFactory"),

    /**
     * 七牛云Kodo QINIUYUN_KODO
     */
    QI_NIU("QINIUYUN_KODO", "com.gitegg.boot.extension.dfs.factory.DfsQiniuFactory"),

    /**
     * 阿里云OSS ALIYUN_OSS
     */
    ALI_YUN("ALIYUN_OSS", "com.gitegg.boot.extension.dfs.factory.DfsAliyunFactory"),

    /**
     * 腾讯云COS TENCENT_COS
     */
    TENCENT("TENCENT_COS", "com.gitegg.boot.extension.dfs.factory.DfsTencentFactory");
