...
public class JustAuthServiceImpl implements IJustAuthService {
     ...
     */
    @Override
    public Long userCreateOrUpdate(@NotNull @RequestBody JustAuthSocialDTO justAuthSocialDTO) {
        UpdateJustAuthSocialDTO createJustAuthSocialDTO = BeanCopierUtils.copyByClass(justAuthSocialDTO, UpdateJustAuthSocialDTO.class);
     ...
     */
    @Override
    public Result<?> userUnbind(@NotNull @RequestParam("socialId") Long socialId, @NotNull @RequestParam("userId") Long userId) {
        QueryJustAuthSocialUserDTO justAuthSocialUserQuery = new QueryJustAuthSocialUserDTO();
        justAuthSocialUserQuery.setSocialId(socialId);
