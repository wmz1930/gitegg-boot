package com.gitegg.boot.extension.wx.miniapp.service.impl;
...
import com.gitegg.boot.extension.wx.miniapp.bo.MiniappExportBO;
import com.gitegg.boot.extension.wx.miniapp.bo.MiniappImportBO;
import com.gitegg.boot.extension.wx.miniapp.config.GitEggWxMaRedissonConfigImpl;
import com.gitegg.boot.extension.wx.miniapp.config.WxMaProperties;
import com.gitegg.boot.extension.wx.miniapp.constant.MiniappConstant;
import com.gitegg.boot.extension.wx.miniapp.dto.CreateMiniappDTO;
...
import com.gitegg.boot.extension.wx.miniapp.dto.UpdateMiniappDTO;
import com.gitegg.boot.extension.wx.miniapp.entity.Miniapp;
import com.gitegg.boot.extension.wx.miniapp.mapper.MiniappMapper;
...
public class MiniappServiceImpl extends ServiceImpl<MiniappMapper, Miniapp> implements IMiniappService {
    ...
    */
    ...
    private String ifConfig(MiniappDTO miniappDTO)
    {
        ...
        if (wxMaService.switchover(miniappDTO.getTenantId() + StrPool.UNDERLINE + miniappDTO.getAppid()))
        {
        ...
        return miniappDTO.getTenantId() + StrPool.UNDERLINE + miniappDTO.getAppid();
    }
    ...
    private void addConfig(MiniappDTO miniappDTO){
        ...
        config.setConfigKey(config.getTenantId() + StrPool.UNDERLINE + miniappDTO.getAppid());
    ...
    private void removeConfig(MiniappDTO miniappDTO){
        // wxMaService删除config
        wxMaService.removeConfig((null != miniappDTO.getTenantId() ? miniappDTO.getTenantId().toString() : AuthConstant.DEFAULT_TENANT_ID.toString()) + StrPool.UNDERLINE + miniappDTO.getAppid());
    }
}
