...
public enum DfsFactoryClassEnum {
     ...
     * MINIO MINIO
     */
    MINIO("2", "com.gitegg.boot.extension.dfs.factory.DfsMinioFactory"),

    /**
     * 七牛云Kodo QINIUYUN_KODO
     */
    QI_NIU("3", "com.gitegg.boot.extension.dfs.factory.DfsQiniuFactory"),

    /**
     * 阿里云OSS ALIYUN_OSS
     */
    ALI_YUN("4", "com.gitegg.boot.extension.dfs.factory.DfsAliyunFactory"),

    /**
     * 腾讯云COS TENCENT_COS
     */
    TENCENT("5", "com.gitegg.boot.extension.dfs.factory.DfsTencentFactory");
