package com.gitegg.boot.extension.sms.enums;
...
public enum SmsFactoryClassEnum {
     ...
     * 阿里云短信
     */
    ALI_YUN("aliyun", "com.gitegg.boot.extension.sms.factory.SmsAliyunFactory"),

    /**
     * 腾讯云短信
     */
    TENCENT("tencent", "com.gitegg.boot.extension.sms.factory.SmsTencentFactory"),

    /**
     * 七牛云短信
     */
    QI_NIU("qiniu", "com.gitegg.boot.extension.sms.factory.SmsQiniuFactory");
